...
function Navbar() {
  // Helper function to auto close navbar on mobile
  const hideNavbar = () => {
    ...
    <div>
      <nav className="navbar navbar-expand-lg">
        <div className="container-fluid">
          <NavLink className="navbar-brand custom-header" id='name' to="/" onClick={hideNavbar}>Mjvirus<span className='off'>official</span></NavLink>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto">
              <li className="nav-item">
                <NavLink className="nav-link active" onClick={hideNavbar} aria-current="page" to="/">Home</NavLink>
              </li>
              <li className="nav-item">
